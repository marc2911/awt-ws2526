...
To do the Break-Out exercises during the tutorials and to complete all assignments, make sure to install these tools _as soon as possible_.

- Text Editor / Web IDE _- choose one -_
