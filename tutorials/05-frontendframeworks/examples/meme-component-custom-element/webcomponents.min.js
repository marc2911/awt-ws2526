...
((window.WebComponents = window.WebComponents || {}),
  (function (e) {
    ...
    ((t.shadow = t.shadow || t.shadowdom || t.polyfill),
      (t.shadow =
        "native" === t.shadow
          ? !1
          : t.shadow || !HTMLElement.prototype.createShadowRoot),
      t.register &&
  ...
  WebComponents.flags.shadow &&
    ...
    (function (e) {
        ...
        for (var i = W(t), a = 0; a < i.length; a++) {
          ...
          if (
            ...
            var c,
              l,
              d = m(t, s);
            if (r && "function" == typeof d.value) n[s] = f(s);
            else {
              var w = u(s);
      ...
      function T(e) {
        return null === e
          ? null
          : (n(S(e)),
            e.__wrapper8e3dd93a60__ ||
              (e.__wrapper8e3dd93a60__ = new (s(e))(e)));
      }
      function M(e) {
    ...
    (function (e) {
      ...
      function y(e, t) {
        ...
        var n = e;
        return ge || "beforeunload" !== n.type || this instanceof M
          ? void U(n, this)
          : new M(n);
      }
      function E(e) {
        ...
        D(_.prototype, {
          ...
          insertBefore: function (e, n) {
            ...
            if (((o = c ? a(e) : i(e, this, s, n)), c))
              (h(this, e), w(this), Y.call(I(this), P(e), r));
            else {
    ...
    (function (e) {
      ...
      if (!("classList" in a)) {
        ...
        (Object.defineProperty(n.prototype, "classList", l),
          delete t.prototype.classList);
      }
    ...
    (function (e) {
      ...
      if (c) {
        n(t.prototype, {
          ...
          texImage2D: function () {
            ((arguments[5] = a(arguments[5])),
              i(this).texImage2D.apply(i(this), arguments));
          },
          texSubImage2D: function () {
            ((arguments[6] = a(arguments[6])),
              i(this).texSubImage2D.apply(i(this), arguments));
          },
        });
    ...
    (function (e) {
      ...
      (y(
        ...
        _(t.prototype, {
          get implementation() {
            ...
            return e
              ? e
              : ((e = new a(N(this).implementation)), D.set(this, e), e);
          },
          get defaultView() {
      ...
      ((a.prototype.createDocument = function () {
        return (
          (arguments[2] = N(arguments[2])),
          C(k.apply(L(this), arguments))
        );
      }),
      ...
      e: for (; (e[u - 1] != f || 0 == u) && !this._isInvalid; ) {
        ...
        switch (l) {
          ...
          case "relative slash":
            if ("/" != y && "\\" != y) {
              ("file" != this._scheme &&
                ((this._host = s._host), (this._port = s._port)),
                (l = "relative path"));
              continue;
            }
            ("\\" == y && c("\\ is an invalid code point."),
        ...
        parseImport: function (e) {
          if (
            (HTMLImports.__importsParsingHook &&
              HTMLImports.__importsParsingHook(e),
            ...
            for (
              ...
              if (!this.isParsed(r))
                return this.hasResource(r)
                  ? t(r)
                    ? this.nextToParseInDoc(r["import"], r)
                    : r
                  : void 0;
          }
          return n;
  ...
  CustomElements.addModule(function (e) {
    ...
    function f(e) {
      if (b.dom) {
        ...
        if (n && "childList" === n.type && n.addedNodes && n.addedNodes) {
          for (var r = n.addedNodes[0]; r && r !== document && !r.host; )
            r = r.parentNode;
          var o =
    ...
    function m(e) {
      for (e = wrap(e), e || (e = wrap(document)); e.parentNode; )
        e = e.parentNode;
      var t = e.__observer;
      t && (f(t.takeRecords()), a());
    }
  ...
  CustomElements.addModule(function (e) {
    ...
    function s(e) {
      if (!Object.__proto__) {
        ...
        for (var o, i = e.prototype; i && i !== t; )
          ((o = Object.getPrototypeOf(i)), (i.__proto__ = o), (i = o));
        e["native"] = t;
      }
    }
    function c(e) {
